...
const StudentDashboard = () => {
  ...
  const fetchStudentData = async () => {
    try {
      // Fetch certificates
      const certResponse = await fetch('/student/certificates');
      if (certResponse.ok) {
      ...
      // Fetch stats
      const statsResponse = await fetch('/student/stats');
      if (statsResponse.ok) {
  ...
  const handleRequestLegacyVerification = () => {
    window.location.href = '/student/legacy-verification';
  };
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.verified_certificates}</p>
              </div>
            </div>
          </div>
